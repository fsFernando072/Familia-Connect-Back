...
import school.sptech.FamiliaConnect.infraestructure.web.mapper.AuditoriaMapper;
...
public class AuditoriaController {
    ...
    public AuditoriaController(AuditoriaUseCase auditoriaUseCase) {
    ...
    public ResponseEntity<AuditoriaResponseDto> cadastrar(@RequestBody @Valid AuditoriaRequestDto dto) {
        Auditoria auditoria = auditoriaUseCase.cadastrar(AuditoriaMapper.toModel(dto));
    ...
    public ResponseEntity<List<AuditoriaResponseDto>> listar() {
        List<Auditoria> auditorias = auditoriaUseCase.listar();
    ...
    public ResponseEntity<AuditoriaResponseDto> buscarPorId(@PathVariable Integer id) {
        Auditoria auditoria = auditoriaUseCase.buscarPorId(id);
        AuditoriaResponseDto responseDto = AuditoriaMapper.toResponse(auditoria);
    ...
    public ResponseEntity<AuditoriaResponseDto> atualizar(@PathVariable Integer id,
        ...
        Auditoria auditoria = auditoriaUseCase.atualizar(id, AuditoriaMapper.toModel(dto));
        AuditoriaResponseDto responseDto = AuditoriaMapper.toResponse(auditoria);
