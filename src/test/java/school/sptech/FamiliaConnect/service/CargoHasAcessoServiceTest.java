...
class CargoHasAcessoServiceTest {
    ...
    class cadastrar {
        ...
        void cadastrarCargoHasAcesso() {
            ...
            CargoHasAcessoRequestDto dto =
                    new CargoHasAcessoRequestDto();

            dto.setCargoId(1);
            dto.setAcessoId(1);
            dto.setPermissaoId(1);

            CargoHasAcesso cargoHasAcesso = CargoHasAcessoMapper.toModel(cargo, acesso, permissao);
            ...
            Mockito.when(permissaoRepository.findById(1))
            ...
            Assertions.assertEquals(permissao.getId(), resultado.getPermissao().getId());
